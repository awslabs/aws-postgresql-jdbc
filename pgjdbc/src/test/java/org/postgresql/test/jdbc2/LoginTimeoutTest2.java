...
public class LoginTimeoutTest2 {
    ...
    private static class TimeoutHelper2 implements Runnable {
        TimeoutHelper2() throws IOException {
    ...
    public void testTimeoutOccurs() throws Exception {
        ...
        TimeoutHelper2 helper = new TimeoutHelper2();
